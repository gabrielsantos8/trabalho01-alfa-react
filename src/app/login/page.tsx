...
export default function Login() {
  ...
  const submitForm = useCallback((e: any) => {
    ...
    if (refForm.current.checkValidity()) {
      ...
      axios
        .post("http://localhost:3000/api/login", objSalvar)
        .then((resposta) => {
          console.log(resposta.data);

          setCookie(undefined, "shoopypainel.token", resposta.data.token, {
            maxAge: 60 * 60 * 24 * 30,
            path: "/",
          });
      ...
      >
        ...
        >
          ...
          >
            ...
            <p>
              Tem uma pergunta/problema? Por favor, escreva aqui e retornaremos
              assim que possível.
            </p>
          </div>
          <hr />
